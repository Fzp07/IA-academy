...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-dev-key-not-for-production')
...
# Database
db_url = env('DATABASE_URL', default='sqlite:///db.sqlite3')
if not db_url or db_url.strip() == '' or db_url.startswith('sqlite'):
    DATABASES = {
        'default': {
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default=env('EMAIL_HOST_USER', default='noreply@aiacademy.com'))
